...
public:
	...
	ofxW2DSlider & add2DSlider(const string & title, float xvalue, float yvalue, float xmin, float xmax, float ymin, float ymax, string controlName="", const string & _style="");
