...
USER_CFLAGS = -I src/ofxKinect/src -I src/ofxKinect/libs/libfreenect -I /usr/include/libusb-1.0 -I /home/arturo/workspace/ofxWidgets/src -Isrc/ofx3DUtils/src
USER_LD_FLAGS = 
USER_LIBS = -lusb-1.0 /home/arturo/workspace/ofxWidgets/Release/libofxWidgets.a
...
$(TARGET): $(OBJS) $(ADDONS_OBJS)
	@echo "linking" $(TARGET)
	$(CXX) -o $@ $(OBJS) $(ADDONS_OBJS) $(LDFLAGS) $(USER_LDFLAGS) $(ADDONSLIBS) $(USER_LIBS) $(TARGET_LIBS) $(LIBS) 
